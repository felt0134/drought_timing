...
#maximum reduction NDVI betwene drought and average years for each pixel
...
filename <- paste0('Data/NDVI/Ecoregion/',Ecoregion,'/max_total_reduction_NDVI_',Ecoregion,'.csv')
