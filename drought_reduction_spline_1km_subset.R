...
filename <- paste0('Data/GPP/Ecoregion/',Ecoregion,'/drought_gpp_reduction_',Ecoregion,'_1km.csv')
write.csv(gpp_reduction_list_df,filename)

gpp_reduction_list_df_2 <- list_to_df(gpp_reduction_list_2)

filename <- paste0('Data/GPP/Ecoregion/',Ecoregion,'/drought_gpp_reduction_absolute_',Ecoregion,'_1km.csv')
