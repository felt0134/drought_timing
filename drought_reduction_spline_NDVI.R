...
filename <- paste0('Data/NDVI/Ecoregion/',Ecoregion,'/drought_ndvi_reduction_',Ecoregion,'.csv')
...
filename <- paste0('Data/NDVI/Ecoregion/',Ecoregion,'/drought_ndvi_reduction_absolute_',Ecoregion,'.csv')
